...
# Caso opte por utilizar a GPU, configurar backend e saída com as duas linhas
# abaixo à seguir:
...
while cap.isOpened():
    ...
    # Leitura da imagem e da variável "success", que é um boleano (True se a 
    # imagem existir ou False).
    ...
    if model_name == "model-f6b98070.onnx":
        ...
        blob = cv2.dnn.blobFromImage(
            img, 1/255., (256, 256), (123.675, 116.28, 103.53), True, False)
    ...
    # Normalizando os pixels da saída entre 0 e 255, um canal de cores e com o
    # tipo equivalente ao numpy.uint8
    ...
    # Convertendo de RGB para BGR (padrão do OpenCV) para que a imagem seja
    # apresentada em RGB pela webcam
    ...
    # Comando para parar processamento ao clicar a tecla "q" em cima do vídeo
    # gerado pela webcam
